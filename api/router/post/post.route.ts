...
import { multipleDeletePosts, adminSingleDeletePost, adminUpdateStatusPost, createNewPost, getAllPosts, getFilterPosts, userSingleDeletePost, userUpdatePost, getPublicPosts, getMaxPages } from '../../controllers/post/post.Controller';
